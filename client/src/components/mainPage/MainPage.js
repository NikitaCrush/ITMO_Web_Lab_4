            ...
            <div className="window">
                <div id="coordinatePanelWrapper"
                    ...
                    <div id="coordinatePanel"
                         style={{position: 'relative', width: '400px', height: '400px', textAlign: 'center'}}>
                        <svg width="400" height="400">
                            ...
                            <path d="M200,200 L140,200 A80,80 0 0,1 200,140 Z"
                                  style={{fill: 'rgba(245, 69, 215, 0.5)', stroke: 'black', strokeWidth: 2}}/>
                            <polygon points="260,200 200,200 200,260"
                                     style={{fill: 'rgba(127, 82, 250, 0.5)', stroke: 'black', strokeWidth: 2}}/>
                            <polygon points="140,200 200,200 200,320 140,320"
                                     style={{fill: 'rgba(25, 59, 252, 0.5)', stroke: 'black', strokeWidth: 2}}/>
                        </svg>
                    </div>
                </div>
                <Inputs/>
